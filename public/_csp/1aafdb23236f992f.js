...
lp=lm?'/csharp-config/'+lm[1]:'/csharp-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/csharp-config/'+lm[1]+'/search-index.json':'/csharp-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}

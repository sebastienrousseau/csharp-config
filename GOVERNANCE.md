...
This document describes how @sebastienrousseau/csharp-config is run: who decides what, how
...
@sebastienrousseau/csharp-config is **maintainer-led**. As of the current release line it has a single

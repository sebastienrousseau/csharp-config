# `@sebastienrousseau/csharp-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/csharp-config`.
...
- [x] **omnisharp.json**: Standardized rule preset
- [x] **Directory.Build.props**: Standardized rule preset
